require = function e(t, n, r) {
    ...
    4: [function(require, module, exports) {
        var fadeInArcticle = require("./fade-in-article"),
            scrollToHash = require("./scroll-to-hash"),
            initMobileNav = require("./mobile-nav"),
            initTriangles = require("./triangle");
        module.exports = function() {
            fadeInArcticle(), scrollToHash(), initMobileNav(), initTriangles()
        }
    }, {
        "./fade-in-article": 3,
        "./mobile-nav": 6,
        ...
        module.exports = function() {
            $(window).on("load resize", function() {
                var width = $(window).innerWidth(),
                    ...
                    rightWidth = leftWidth > width / 2 ? leftWidth - 1 : leftWidth;
                $(".triangle").css({
    ...
    6: [function(require, module, exports) {
        ...
        module.exports = function() {
            $(".bars", "header").on("click", function(e) {
                e.preventDefault(), $(".bars", "header").hide(), $(".close", "header").show(), $("nav", "header").show()
            }), $(".close", "header").on("click", function(e) {
                e.preventDefault(), $(".bars", "header").show(), $(".close", "header").hide(), $("nav", "header").hide()
            }), $(window).on("load resize", function() {
                $(window).outerWidth() > 767 ? ($(".bars", "header").hide(), $(".close", "header").hide(), $("nav", "header").show()) : ($(".bars", "header").show(), $(".close", "header").hide(), $("nav", "header").hide())
            })
        }
    }, {
        jquery: 10
    ...
    3: [function(require, module, exports) {
        ...
        function initFadeInArcticle() {
            $("article.features").length > 0 &&
                $(window).scrollTop() >= $("article.features").offset().top - $(window).innerHeight() + 300 &&
                $("article.features").addClass("show");

            $("article.security").length > 0 &&
                $(window).scrollTop() >= $("article.security").offset().top - $(window).innerHeight() + 300 &&
                $("article.security").addClass("show") &&
                $("article.security .wrap p").addClass("show");
        }
        module.exports = function() {
            initFadeInArcticle(), $(window).on("load resize scroll", function() {
                initFadeInArcticle()
            })
        }
    }, {
